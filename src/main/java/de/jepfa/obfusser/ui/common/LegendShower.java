...
public class LegendShower {
    public static void showLegend(Activity activity, Representation representation) {
        ...
        String legend = buildLegend(activity, representation, true);
    ...
    @NonNull
    public static String buildLegend(Activity activity, Representation representation, boolean extraSpace) {
    ...
    private static void buildExtraSpace(StringBuilder sb, boolean extraSpace) {
        if (extraSpace) {
            sb.append(Constants.NL);
        }
    }
