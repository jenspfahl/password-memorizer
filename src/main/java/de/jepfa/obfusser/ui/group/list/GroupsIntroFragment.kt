...
class GroupsIntroFragment : CommonMenuFragmentBase() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.navtab_group_intro, container, false)
        activity!!.setTitle(R.string.title_groups)

        val fab : FloatingActionButton = view.findViewById(R.id.fab)
        fab.setOnClickListener(View.OnClickListener { view ->
            val context = view.context
            val intent = Intent(context, GroupInputNameActivity::class.java)
